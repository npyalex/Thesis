...
public class TextFade : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        startColor = fadeObject.GetComponent<TextMesh>().color; //hold the color of the target object
    ...
    public void Fade()
    {
        ...
        fadeObject.GetComponent<TextMesh>().color = Color.Lerp(startColor, endColor, percent);
    }
