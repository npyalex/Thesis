...
1. "Interactive Grass/Model" shader works on independent grass model.
   Grass can interactive with character movement.
   Grass support "fire burn out" effect.
   "Grass.cs" help to control an independent grass, calculate the collision force with character and offer burn out control interface.

2. "Interactive Grass/Large Scale" shader is designed for large scale procedural grass rendering.
   Use GPU tessellation generate large scale grass from a simple plane.
...
Hold direction key can move the capsule (aka "Character" in hierarchy window), it can interactive with the grass.
...
"Demo-ModelGrass" demonstrates "Interactive Grass/Model" grass shader features.
"Demo-LargeScaleGrass" demonstrates "Interactive Grass/Large Scale" grass shader features.
